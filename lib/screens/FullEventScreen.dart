...
class FullEventScreen extends StatefulWidget {
  ...
  FullEventScreen({required this.uid});
  @override
...
class _FullEventScreenState extends State<FullEventScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final String title = "The Google Seminar"; //Title
    final String city = "London"; //City
    final double ticketPrice = 75.66; //Price
    final String startTime = "02:00 GMT"; //Start time
    final String imageUrl =
        "https://images.unsplash.com/photo-1551808525-51a94da548ce?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=696&q=80"; //The image url
    final String description =
        "Lorem de ipsum Lorem de ipsum. Here is just a test dscription for the following event to showcase some good UI. The reader of the event description finds it intresting as he is yet reading till now. Come On pal!! Leave it. Its just a dummy text over here. Lorem de ipsum Lorem de ipsum."; //Description
    final double lattitute = 51.507351; //Lattitude
    final double longitude = -0.127758; //Longitude
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            //Following container, just draws a line on the UI
            Container(
              margin: EdgeInsets.only(left: 60, right: 60, top: 0, bottom: 0),
              width: double.infinity,
              height: 1,
              color: Colors.black45,
            ),
